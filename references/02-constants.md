...
public static final longserialVersionUID = 1L;
```
**错误示例**：
```java
...
public interface StatusEnum {
    ...
    String ERROR = "error";  // OK，隐式 static final
}
```
...
// 常量分散在多个不相关的类中
public class UserService {
    static final String ORDER_PENDING = "PENDING";  // 不应在Service中定义Order常量
}
```
**修复建议**：按功能模块组织常量类
